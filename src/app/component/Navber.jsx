...
const Navber = () => {
  ...
  const navLinks = [
    ...
    { name: "My Added Cars", href: "/mycars" },
    { name: "My Bookings", href: "/mybookings" },
  ];

  return (
    <nav className="fixed top-0 left-0 z-50 w-full px-4 md:px-8 pt-4">
      <div className=" relative mx-auto flex h-20 max-w-7xl items-center justify-between rounded-2xl border border-white/10 bg-black/30 backdrop-blur-2xl px-6 lg:px-10 shadow-[0_8px_32px_rgba(0,0,0,0.45)]">
        ...
        <Link  href="/"  className="  absolute  left-1/2  -translate-x-1/2  md:relative md:left-0  md:translate-x-0  no-underline">
                ...
                <Dropdown.Menu className="text-white">
                  ...
                  <Dropdown.Item id="profile" textValue="Profile">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <IoPersonSharp className="size-4 text-[#C8A96B]" />
                    </div>
                  </Dropdown.Item>
