        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            ...
            <Card className="w-full max-w-md bg-white p-8 border border-gray-100 shadow-sm rounded-none">
                <Form onSubmit={onSignUp} className="flex flex-col gap-5">
                    ...
                    <Button
                        type="submit"
                        className="w-full bg-[#13a3ca] text-white py-2.5 font-medium hover:bg-[#108dae] transition-colors rounded-none mt-2"
                    >
                        Create Account
                    </Button>
                    ...
                    <Button
                        onClick={signIn}
                        variant="bordered"
                        className="w-full bg-white border border-gray-200 py-2.5 text-gray-700 font-medium hover:bg-gray-50 flex items-center justify-center gap-2 rounded-none"
                    >
                        <FcGoogle />
                        Sign Up With Google
                    </Button>
                    ...
                    <div className="text-center text-sm text-gray-500 mt-2">
                        ...
                        <Link href="/login" className="text-[#13a3ca] font-medium hover:underline">
                            Sign In
                        </Link>
                    </div>
                </Form>
