...
const AddCarPage = () => {
    ...
    if (!user) {
        return (
            <section className="flex min-h-screen items-center justify-center bg-[#050505] px-4 text-white">
                ...
                <div className="w-full max-w-xl rounded-[32px] border border-white/10 bg-gradient-to-b from-[#111111] to-[#090909] p-10 text-center">
                    ...
                    <p className="mt-4 text-sm leading-7 text-gray-400">
                        Please sign in before adding a new luxury car listing to your garage.
                    </p>
    ...
    return (
        <section className="min-h-screen bg-[#050505] py-14 text-white">
            ...
            <div className="container mx-auto max-w-6xl px-4 md:px-6">
                ...
                <div className="mb-12 flex flex-col justify-between gap-6 border-b border-white/10 pb-8 md:flex-row md:items-end">
                    ...
                    <div>
                        ...
                        <p className="mt-4 max-w-2xl text-sm leading-7 text-gray-400">
                            Showcase your premium vehicle collection and start accepting luxury rentals.
                        </p>
                ...
                <form onSubmit={onSubmit} className="overflow-hidden rounded-[36px] border border-white/10 bg-gradient-to-b from-[#111111] to-[#090909] p-6 shadow-[0_0_60px_rgba(0,0,0,0.35)] md:p-10">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <Select.Trigger className="flex h-16 items-center justify-between rounded-2xl border border-white/10 bg-white/[0.03] px-5 transition-all duration-300 hover:border-white/20">
                                ...
                                <Select.Popover className="overflow-hidden rounded-2xl border border-white/10 bg-[#111111] p-2">
                                    ...
                                    <ListBox className="space-y-1">
                                        ...
                                        <ListBox.Item id="SUV" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">SUV</ListBox.Item>

                                        <ListBox.Item id="Sedan" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Sedan</ListBox.Item>

                                        <ListBox.Item id="Hatchback" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Hatchback</ListBox.Item>

                                        <ListBox.Item id="Luxury" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Luxury</ListBox.Item>

                                        <ListBox.Item id="Coupe" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Coupe</ListBox.Item>

                                        <ListBox.Item id="Pickup" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Pickup</ListBox.Item>

                                        <ListBox.Item id="Van" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Van</ListBox.Item>

                                        <ListBox.Item id="Electric" className="rounded-xl px-4 py-3 text-sm text-gray-300 hover:bg-white/[0.04]">Electric</ListBox.Item>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <TextField name="description" isRequired>
                                ...
                                <TextArea
                                    ...
                                    className="min-h-[180px] rounded-3xl border border-white/10 bg-white/[0.03] px-5 py-4 text-white placeholder:text-gray-500"
                                />
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="flex items-center justify-between rounded-[28px] border border-white/10 bg-white/[0.02] p-6">
                    ...
                    <div className="mt-10 border-t border-white/10 pt-8">
                        ...
                        <Button
                            type="submit"
                            className="h-16 w-full rounded-2xl border border-[#b89b65]/10 bg-[#b89b65]/10 text-sm font-bold uppercase tracking-[4px] text-[#d6bb84] transition-all duration-300 hover:bg-[#b89b65]/20"
                        >
                            Add Car Listing
                        </Button>
