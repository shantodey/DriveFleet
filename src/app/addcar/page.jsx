        ...
        <div className="container mx-auto">
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto p-10 space-y-8 shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {/* Availability Status */}
                    <div className="md:col-span-2 flex items-center justify-between rounded-2xl border border-divider bg-default/20 px-5 py-4">
                        <div>
                            <p className="text-sm font-semibold text-foreground">Availability Status</p>
                            <p className="text-xs text-foreground/50">Is this car available for booking?</p>
                        </div>
                        <Switch name="available" defaultSelected color="primary" size="lg" />
                    </div>
